...
// ROUTE CONTENTS
Route::get('index-content', [ContentController::class,'index'])->middleware(['auth:sanctum']); // http://127.0.0.1:8000/api/index
Route::get('contents/{id}', [ContentController::class, 'show']);
Route::put('update-content/{id}/update', [Content::class,'update']); // http://127.0.0.1:8000/api/update-profile  + middleware
Route::delete('delete-content/{id}', [ContentController::class, 'destroy']);
Route::post('create-content', [ContentController::class,'create']); // http://127.0.0.1:8000/api/register
